        ...
        <div class="col-lg-8 col-md-10">
            <div class="card rounded-3 shadow-sm">
                <div class="card-body p-4">
                    <h3 class="card-title mb-4">Seat Selection</h3>
                    <!-- Display user data -->
                    <form action="{{ route('reserves.store') }}" method="post" id="seatForm">
                        @csrf
                        <input type="hidden" name="selectedseat" id="selectedSeatsInput" value="">
                        <div class="center">
                            <div class="tickets">
